...
import dev.agentsforcursor.ui.detail.AgentDetailContent
import dev.agentsforcursor.ui.detail.AgentDetailViewModel
import dev.agentsforcursor.ui.inbox.InboxContent
import dev.agentsforcursor.ui.inbox.InboxViewModel
import dev.agentsforcursor.ui.newagent.NewAgentContent
import dev.agentsforcursor.ui.newagent.NewAgentViewModel
import dev.agentsforcursor.ui.settings.SettingsContent
import dev.agentsforcursor.ui.settings.SettingsViewModel
import dev.agentsforcursor.ui.signin.SignInContent
import dev.agentsforcursor.ui.signin.SignInViewModel
...
class ScreenRenderTest {
    ...
    private fun capture(name: String, content: @Composable () -> Unit) {
        compose.setContent {
            AgentsTheme(darkTheme = true) { content() }
        }
